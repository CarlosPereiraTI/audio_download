...
# ===============================================================================================================================
# Select the option with radiobuttons
var = IntVar()

def selection():
    option = var.get()
    # print(option) # Debug selection
    return option

# radiobuttons using grid
...
def download():
    if (selection() == 1):
        ...
        tkinter.messagebox.showwarning(title="Tina | Youtube Downloader", message="Please, select an option: Audio MP3 or Video MP4!")
